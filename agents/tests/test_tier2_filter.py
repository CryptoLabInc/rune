...
class TestTier2Filter:
    ...
    def filter_with_mock(self, mock_anthropic_response):
        """Create a Tier2Filter with mocked Anthropic client"""
        ...
        f._client = Mock()
        f._client.messages.create.return_value = mock_anthropic_response(
            capture=True,
    ...
    def test_evaluate_captures_decision(self, filter_with_mock, mock_anthropic_response):
        ...
        filter_with_mock._client.messages.create.return_value = mock_anthropic_response(
            capture=True,
    ...
    def test_evaluate_fallback_on_error(self, filter_with_mock):
        ...
        filter_with_mock._client.messages.create.side_effect = Exception("API error")
    ...
    def test_text_truncation(self, filter_with_mock, mock_anthropic_response):
        ...
        call_args = filter_with_mock._client.messages.create.call_args
        user_msg = call_args.kwargs["messages"][0]["content"]
        # Message prefix "Message: " + 500 chars max
