...
Monitor the current conversation for **significant decisions and organizational knowledge**. When you detect something worth capturing, call the `capture` MCP tool. The tool handles the full 3-tier pipeline internally:
