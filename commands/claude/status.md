...
- `envector_key_invalid`: "enVector API key was rejected. Vault 관리자에게 문의하세요."
- `envector_not_provisioned`: "Rune-Vault에 체결되어 있는 enVector Cloud 엔드포인트가 없습니다. Vault 관리자에게 문의하세요."
