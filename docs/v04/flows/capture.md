...
// 상세는 components/embedder-integration.md 참조
...
- **Recall flow**: `flows/recall.md` (완성, 7-phase)
- **Lifecycle flow**: `flows/lifecycle.md` (완성, 6-tool + 부팅·Vault retry·shutdown)
- **Phase chain expansion**: D27에서 MVP 유지 결정. `flows/recall.md` Phase 6 참조
- **에이전트 ExtractionResult shape**: `decisions.md` D4 `extracted` JSON 계약 참조
