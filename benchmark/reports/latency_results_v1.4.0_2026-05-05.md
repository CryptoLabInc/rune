...
`insert` phase가 capture 전체 시간의 92%. 내부적으로 FHE 암호화 + 원격 envector insert가 합쳐진 구간이며, pyenvector 1.4.0a5의 PPMM cache (1.31–1.40x 가속) 가 적용된 후의 수치임에도 절대값은 4.2–5.0초 수준. 다음 측정 라운드에서:
